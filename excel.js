(function() {
    ...
    class Excel extends HTMLElement {
        ...
        onCustomWidgetAfterUpdate(changedProperties) {
            ...
            let xlsxjs = "https://raw.githubusercontent.com/sacabunayyanholdings/HR_Input/refs/heads/main/xlsx.js";
                                        ...
                                        if (result.split("[$@~!~@$]")[i].length > 0) {
                                            ...
                                            if (rec.length > 0) {
                                                len = rec[0].trim().length + rec[1].trim().length + rec[2].trim().length + rec[3].trim().length + rec[4].trim().length + rec[
                                                    5].trim().length + rec[6].trim().length + rec[7].trim().length + rec[8].trim().length + rec[9].trim().length + rec[10].trim().length + rec[11].trim().length + rec[12].trim().length + rec[13].trim().length + rec[14].trim().length
+ rec[15].trim().length;
                                                if (len > 0) {
                                                    ...
                                                    result_final.push({
                                                        ...
                                                        'NATIONALITY': rec[2].trim(),
                                                        'POSITION': rec[3].trim(),
                                                        'GRADE': rec[4].trim(),
                                                        'HIRE_DATE': rec[5].trim(),
                                                        'COUNTRY': rec[6].trim(),
                                                        'CITY': rec[7].trim(),
                                                        'STATUS': rec[8].trim(),
                                                        'DEPARTMENT': rec[9].trim(),
                                                        'COMP_CODE': rec[10].trim(),
